...
def main():
    employees = []
    ftEmployee1 = FulltimeEmployee("Akhil", "Kasanagottu", 250000, "Software Engineering")
    ftEmployee1.full_time_member()
    employees.append(ftEmployee1)
    ftEmployee2 = FulltimeEmployee("Sai Kumar", "Manda", 170000, "Cyber Security")
    employees.append(ftEmployee2)
    employee1 = Employee("Hrishi", "Baroori", 150000, "Testing")
    employees.append(employee1)
    employee2 = Employee("Ram", "Pothineni", 192000, "Product Manager")
